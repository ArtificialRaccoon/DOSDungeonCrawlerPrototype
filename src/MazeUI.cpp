...
void MazeUI::Init(BITMAP *INPUT_BUFFER)
{
    ...
    LoadUISprite(SHEET, MAZEBORDER_CORNER, CommonGUI::Instance().GetPalette(), MAPWINC_STARTX, MAPWINC_STARTY, MAPWINC_WIDTH, MAPWINC_HEIGHT);
    LoadUISprite(SHEET, CHAR_TOPCORNER, CommonGUI::Instance().GetPalette(), CHARWINTC_STARTX, CHARWINTC_STARTY, CHARWINC_WIDTH, CHARWINC_HEIGHT);
    LoadUISprite(SHEET, CHAR_BOTTOMCORNER, CommonGUI::Instance().GetPalette(), CHARWINBC_STARTX, CHARWINBC_STARTY, CHARWINC_WIDTH, CHARWINC_HEIGHT);
    LoadUISprite(SHEET, ARROW, CommonGUI::Instance().GetPalette(), ARROW_X, ARROW_Y, ARROW_WIDTH, ARROW_HEIGHT);
}
