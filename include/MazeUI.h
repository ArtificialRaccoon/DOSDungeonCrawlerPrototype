...
class MazeUI
{
    public:
        ...
        void DrawMazeUI(int startX, int startY, Dungeon &currentDungeon, Rotation facing, int playerX, int playerY, GameProcessor* game);             
        ...
        void DrawCharacterWindow(Character *characterObj, int xOffset, int yOffset);
